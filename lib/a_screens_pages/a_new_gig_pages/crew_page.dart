...
//       stream: DatabaseService(userUid: user.uid, uidGig: widget.uidGig).crewMemberList,
...
//                           }).toList(),
//                       validator: (value) => value == 'Please Select Permission' ? 'Please Select Permission' : null,
//                     ),
//                   ),
//                   SizedBox(height: 8,),
...
//                                     )
//                                     .setCrewData(
//                                   nameCrew: _controller.text, //TODO: use persons email or uid
...
//                     child: CrewMembersList(uidGig: widget.uidGig,)
